...
public class VisibilityHandler : MonoBehaviour {
    ...
    private SignboardVisibility[] GetSignboardArray() {
        return null;
    ...
    public void GenerateVisibilityData() {
        ...
        // analyzeSignboards();//TODO
        // generateTextures();//TODO
    ...
    //                 SignboardVisibility signBoard = GetSignboardArray()[signageboardID];
    ...
    //
    //     for(int signageboardID = 0; signageboardID < GetSignboardArray().Length; signageboardID++) {
    //         SignboardVisibility signageboard = GetSignboardArray()[signageboardID];
    //         signageboard.coveragePerAgentType = new float[agentTypes.Length];
    //         for(int agentTypeID = 0; agentTypeID < agentTypes.Length; agentTypeID++) {
    //             float coverage = (float)signboardCoverage[signageboardID, agentTypeID] / visibilityGroupMaxSize;
